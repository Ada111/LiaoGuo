...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //将要分页显示的View装入数组中
        ...
        View view1 = mLi.inflate(R.layout.main_tab_chat, null);
        View view2 = mLi.inflate(R.layout.main_tab_freinds, null);
        View view3 = mLi.inflate(R.layout.main_tab_timeline, null);
        View view4 = mLi.inflate(R.layout.main_tab_etc, null);
